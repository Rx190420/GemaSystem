...
import {
  Plus, Search, X, Trash2, Clock, Loader2, ChevronDown, Check,
                  ...
                  <table className="w-full text-sm border-collapse">
                    <thead>
                      <tr className="bg-gray-50 border-b-2 border-gray-100">
                        ...
                        <SortableTh sortKey="visit_date" sort={sort} onSort={handleSort} className="text-left px-4 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">Fecha y hora</SortableTh>
                        <SortableTh sortKey="visit_type" sort={sort} onSort={handleSort} className="text-left px-4 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">Tipo</SortableTh>
                        ...
                        <SortableTh sortKey="price" sort={sort} onSort={handleSort} className="text-left px-4 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wider hidden lg:table-cell">Precio</SortableTh>
