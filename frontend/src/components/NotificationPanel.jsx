...
import {
  ...
  UserPlus, CreditCard, Trophy, Clock, AlertTriangle, Sparkles, Gift, Package,
} from 'lucide-react'
...
const TYPE_CFG = {
  ...
  member_birthday:     { Icon: Gift,            color: '#ec4899', bg: 'rgba(236,72,153,0.13)' },
  low_stock:           { Icon: Package,         color: '#f97316', bg: 'rgba(249,115,22,0.13)' },
}
